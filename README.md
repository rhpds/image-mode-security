...
A hands-on lab covering some security features and how they apply to RHEL Image Mode.  Focusing on compliance policy and fapolicyd.

**Owner:** nlager
**Migrated from:** https://github.com/rhel-labs/zt-image-mode-security.git
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/image-mode-security`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/image-mode-security
   ```
3. `cd image-mode-security`
